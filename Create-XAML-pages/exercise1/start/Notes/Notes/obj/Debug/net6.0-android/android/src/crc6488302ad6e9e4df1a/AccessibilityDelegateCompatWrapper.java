...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Microsoft.Maui.AccessibilityDelegateCompatWrapper, Microsoft.Maui", AccessibilityDelegateCompatWrapper.class, __md_methods);
	}
	...
	public AccessibilityDelegateCompatWrapper ()
	{
		...
		if (getClass () == AccessibilityDelegateCompatWrapper.class)
			mono.android.TypeManager.Activate ("Microsoft.Maui.AccessibilityDelegateCompatWrapper, Microsoft.Maui", "", this, new java.lang.Object[] {  });
	}
	...
	public AccessibilityDelegateCompatWrapper (android.view.View.AccessibilityDelegate p0)
	{
		super (p0);
		if (getClass () == AccessibilityDelegateCompatWrapper.class)
			mono.android.TypeManager.Activate ("Microsoft.Maui.AccessibilityDelegateCompatWrapper, Microsoft.Maui", "Android.Views.View+AccessibilityDelegate, Mono.Android", this, new java.lang.Object[] { p0 });
	}
	...
	public AccessibilityDelegateCompatWrapper (androidx.core.view.AccessibilityDelegateCompat p0)
	{
		super ();
		if (getClass () == AccessibilityDelegateCompatWrapper.class)
			mono.android.TypeManager.Activate ("Microsoft.Maui.AccessibilityDelegateCompatWrapper, Microsoft.Maui", "AndroidX.Core.View.AccessibilityDelegateCompat, Xamarin.AndroidX.Core", this, new java.lang.Object[] { p0 });
	}
